...
k7=.0065; % wick for helium normal conduction

qc=200; % steady pW to copper after demag
qc=qc*1e-12;
qqq=200; %increased copper heating during demag

qcb=.1;  % wick for eddy current prop Bdot^2
...
tt=36; % total time in hours
td=3.7; %demag time, to mid field in hours
wait=0; %wait time at mid field
tdd=14; % demag time, mid to final field
sd=td*3600;
sdd=tdd*3600;
ttt=tt*3600; %secs
step=1;
