...
%version with eddy current heating
...
td=.2; %demag time, to mid field in hours
wait=0; %wait time at mid field
tdd=24; % demag time, mid to final field 13
sd=td*3600;
sdd=tdd*3600;
ttt=tt*3600; %secs 
step=1;
...
t0=0.0075;   %K   %start temperature  .0075
