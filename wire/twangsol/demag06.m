...
% heat leak to helium
qh=700; %pW far heium
qqh=300; %pw near helium
qh=qh*1.0e-12;
qqh=qqh*1e-12;

k7=.1; % wick for helium normal conduction   .006?

qc=2900; % steady pW to copper after demag
qc=qc*1e-12;
qqq=1; % factor during demag for copper 

qcb=6;  % wick for eddy current prop Bdot^2    .1?  6?
...
a=600;  %sinter area in m^2   was 200
...
tt=40; % total time in hours
td=10; %demag time, to mid field in hours
