*UPTODATE E02CBETEXT
      SUBROUTINE E02CBE(MFIRST, MLAST, K, L, X, XMIN, XMAX, Y,
     * YMIN, YMAX, FF, A, NA, WORK, NWORK, IFAIL)
...
C
C     .. SCALAR ARGUMENTS ..
      REAL*8 XMAX, XMIN, Y, YMAX, YMIN
      INTEGER IFAIL, K, L, MFIRST, MLAST, NA, NWORK
C     .. ARRAY ARGUMENTS ..
      REAL*8 A(NA), FF(MLAST), WORK(NWORK), X(MLAST)
C     ..
C     .. LOCAL SCALARS ..
      CHARACTER SRNAME*8
      REAL*8 D, XCAP, YCAP
...
C
      DO 40 I=1,KP1
         R = R + LP1
         CALL E02AEE(LP1, A(R), YCAP, WORK(I), IERROR)
         IERROR = IERROR + 1
...
C
      DO 60 R=MFIRST,MLAST
         ...
         IERROR = 1
         CALL E02AEE(KP1, WORK, XCAP, FF(R), IERROR)
