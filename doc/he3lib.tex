...
\begin{figure}[h]
\includegraphics[scale=1.1]{gap1.eps}\\
\end{figure}
\eject
...
See more information in the source file {\tt he3\_text\_gr.f}.
...
\tt he3\_text\_cperp(ttc, p) & Velosity of spin waves propagating in a direction
transverse to $\bf n$:\par
$c_\perp = \displaystyle \gamma\sqrt{8\lambda_{G2}/\chi} $, [cm/s]\\

\tt he3\_text\_c(ttc, p) & Bending stiffness coefficient
$c = \displaystyle 65/8\ \lambda_G $, [erg/cm]\\
