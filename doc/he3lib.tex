...
\tt rota\_nmra\_f(n)  & frequencies of nmrA spectrometer,kHz for n=1..8 (use real*8 n!)\\
...
\tt rota\_rrda      & radiation damping constant for the nmrA spectrometer\\
\end{tabular}
...
\tt qball\_cpar(P)  & cpar (measured), [cm/s]\\
\tt qball\_cper(P)  & cper (measured), [cm/s]\\
\tt qball\_dbetan(P, f0)  & Derivative of the textural angle beta\_N in the center of the cell (rota-specific, measured), [rad/cm]\\
\tt qball\_fz0(P,f0,Imin)  & 1/2 of distance between visible axial levels (rota-specific, measured), [Hz]\\
\tt qball\_fr0(P,f0,Imin)  & 1/2 of distance between visible radial levels (rota-specific, measured), [Hz]\\
\tt qball\_az0(P,f0,Imin)  & z size of the magnon condensate (rota-specific, measured), [cm]\\
\tt qball\_ar0(P,f0,Imin)  & r size of the magnon condensate (rota-specific, measured), [cm]\\
\tt qball\_trd(P,f0,fr,fz) & $\tau_{RD}$ for the magnon condensate with given radial and axial frequencies (rota-specific, measured) [s]\\
\tt qball\_trd0(P,f0,imin) & $\tau_{RD}$ for the magnon condensate (no rotation, rota-specific, measured) [s]\\
