...
\tt he3\_2n0(P)    & $\displaystyle 2N(0) = \frac{\gamma_f}{v_m}
                     \ \frac{3 N_A}{k_B \pi^2}$,~[1/(erg cm$^3$)]\\
...
\tt he3\_gd(p) & Experimental value of Dipolar coefficient $g_d$,~[1/(erg cm$^3$)]\\
...
\tt he3\_nu\_b1(ttc, p)       &B-phase Leggett frequency, calculated from $g_d$, Hz\newline
                             $\displaystyle \nu_B = \frac{\gamma}{2\pi}
                               \sqrt{15 \Delta^2 g_d/\chi_B}$\\
\end{tabular}
\medskip
