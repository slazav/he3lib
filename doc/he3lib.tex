...
\tt he3\_tau0(ttc, gap) & Quasiparticle lifetime at fermi level, $\tau(0,T)$ s\newline
                             $\tau(E,T) = \tau_N(0,T) / I (E,T)$\\
\tt he3\_tau\_av(ttc, gap) & Average quasiparticle lifetime $\bar\tau(T)$\newline
                             $\bar\tau =Y_0/ \int \phi_k/tau(E_k) d\xi $\\
