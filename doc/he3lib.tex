...
\tt qball\_dbetan(P, nu0)  & Derivative of the textural angle beta\_N in the center of the cell (rota-specific, measured), [rad/cm]\\
\tt qball\_fz(P,nu0,Imin)  & 1/2 of distance between visible axial levels (rota-specific, measured), [Hz]\\
\tt qball\_fr(P,nu0,Imin)  & 1/2 of distance between visible radial levels (rota-specific, measured), [Hz]\\
\tt qball\_az(P,nu0,Imin)  & z size of the magnon condensate (rota-specific, measured), [cm]\\
\tt qball\_ar(P,nu0,Imin)  & r size of the magnon condensate (rota-specific, measured), [cm]\\
\end{tabular}
