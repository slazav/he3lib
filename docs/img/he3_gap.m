#!/usr/bin/octave-cli -qf
  ...
  plot(ttc, he3_bcsgap(ttc), 'r-', 'linewidth', 1)
  plot(ttc, gg00, 'k-', 'linewidth', 1)
  ...
  plot(ttc, he3_yosida(ttc,gg00,0), 'r', 'linewidth', 1)
  plot(ttc, he3_yosida(ttc,gg00,2), 'color', [0 0.6 0], 'linewidth', 1)
  plot(ttc, he3_yosida(ttc,gg00,4), 'b', 'linewidth', 1)
  ...
  plot(ttc, he3_chi_b(ttc,0), 'k', 'linewidth', 1);
  plot(ttc, he3_chi_b(ttc,30), 'k', 'linewidth', 2);

  plot(ttc, he3_rho_nb(ttc,0), 'b', 'linewidth', 1);
  ...
  text(0.70, 0.92, '\rho^n_B/\rho_N', 'fontsize', 8, 'color', 'b');
  text(0.10, 0.42, '\chi^n_B/\chi_N'   , 'fontsize', 8, 'color', 'k');
